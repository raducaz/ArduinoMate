...
public class MainActivity extends AppCompatActivity {
    ...
    /** Shows the device detail fragment */
    public void show(Device device) {

        DeviceFragment deviceFragment = DeviceFragment.forDevice(device.getId());
    ...
    /** Shows the function detail fragment */
    public void show(Function function) {

        FunctionFragment functionFragment = FunctionFragment.forFunction(function.getId());
    ...
    public void startTcpServerService(Function function)
    {
